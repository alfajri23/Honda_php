  ...
  <main id="main">
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <span>
          <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambah">Tambah</button>
          </span>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a onclick="modalEdit(<?php echo $baris[0] ?>)" class="btn btn-secondary btn-sm"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php
            }
